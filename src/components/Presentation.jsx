            ...
            <div className="presentation">
                ...
                <div className="presentation-contactMe">
                    ...
                    <div className="presentation-contactMe_gitTwitLinkendin">
                        ...
                        <a href="https://www.linkedin.com/in/johan-avila-41098a129/" target="_blank">
                        ...
                        <a href="https://github.com/johan-avila" target="_blank">
                        ...
                        <a href="https://twitter.com/johan__ag" target="_blank">
